...
function calc() {
  ...
  initLocaSettings('.calculating__choose_big div', 'calculating__choose-item_active'); // function initDynemicInformation(selector) {
...
function modal(trigerSelector, modalSelector, modalTimerId) {
  var modalTriger = document.querySelectorAll(trigerSelector),
      modal = document.querySelector(modalSelector);
  modalTriger.forEach(function (btn) {
...
function sliders(_ref) {
  ...
  var slides = document.querySelectorAll(slide),
      ...
      slidesWreapper = document.querySelector(wrapper),
      slidesField = document.querySelector(field),
      width = window.getComputedStyle(slidesWreapper).width;
  var slideIndex = 1;
  var offset = 0;
  ...
  slidesWreapper.style.overflow = 'hidden';
  ...
  function delPx(world) {
    return +world.replace(/\D/g, '');
  }
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__.openModal)('.modal', modalTimerId);
  }, 40000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2022-12-10');
});
}();
/******/ })()
;
